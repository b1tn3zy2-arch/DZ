...
Функционал данной страницы это кнопка главная и расписание который имеет переход на данную страницу 
...
При нажатии на "Расписание" открывается трудовой распорядок
